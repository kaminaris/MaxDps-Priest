...
function Shadow:cds()
    if (MaxDps:CheckSpellUsable(classtable.PowerInfusion, 'PowerInfusion')) and ((buff[classtable.VoidformBuff].up or buff[classtable.DarkAscensionBuff].up and (ttd <= 80 or ttd >= 140)) and (not buff[classtable.PowerInfusionBuff].up or (MaxDps and MaxDps.ActiveHeroTree == 'tww2' and MaxDps.tier and MaxDps.tier[33].count >= 4 and 1 or 0) and buff[classtable.PowerInfusionBuff].remains <= 15)) and cooldown[classtable.PowerInfusion].ready then
